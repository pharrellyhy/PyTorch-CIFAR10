...
def densenet161(**kwargs):
    model = DenseNet(growth_rate=48, num_init_features=96, block_config=(6, 12, 36, 24), **kwargs)

    return model


def densenet169(**kwargs):
    model = DenseNet(growth_rate=32, num_init_features=64, block_config=(6, 12, 32, 32), **kwargs)

    return model


def densenet201(**kwargs):
    model = DenseNet(growth_rate=32, num_init_features=64, block_config=(6, 12, 48, 32), **kwargs)

    return model


def densenet_cifar(**kwargs):
    model = DenseNet(growth_rate=12, num_init_features=64, block_config=(6, 12, 24, 16), **kwargs)
